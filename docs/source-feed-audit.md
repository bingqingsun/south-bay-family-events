...
| 3 | The Tech Interactive | 官方网页日历 | [Upcoming Events](https://www.thetech.org/explore/upcoming-events)含具体日期、图片及 STEM/家庭项目。 | 适合 K–12；未发现批量订阅入口。可后续为此页面单独开发、测试稳定的官方网页读取器。 |
...
| 15 | Foothill College | 官方固定项目／网页 | [Physics](https://foothill.edu/physics/)说明 Physics Show 于秋冬举办；[Observatory](https://foothill.edu/astronomy/observatory.html)公布每周免费公众观测。 | **已确认你提到的 Physics Show 是真实官方项目。** 但具体场次跳转至外站，尚未发现可订阅官方校历；保留搜索兜底，并可后续把稳定的周五／周六观测作为规则化官方项目接入。 |
...
- 当前直接来源：**4** 个。
- 尚在搜索兜底的来源：**18** 个；按每周二、周四运行，约为 **144 次／4 周**（或 5 周月份约 180 次）SerpApi 查询。
