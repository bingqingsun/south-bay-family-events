window.SBFF_WEEKEND_PICKS = {
  ...
  picks: [
    ...
    {
      eventRef: { title: 'Magic Tree House', url: 'https://daweb2.deanza.edu/events/event.html?id=191544800' },
      label: 'Family Finds Pick',
      whyWePicked: 'The familiar Jack-and-Annie story turns a planetarium visit into an accessible space adventure, making it an easy bridge between storytelling and science.'
    },
    {
      eventRef: { title: 'Black Holes: The Other Side of Infinity', url: 'https://daweb2.deanza.edu/events/event.html?id=191545133' },
    ...
    {
      eventRef: { title: 'Science of Spa Day', url: 'https://sccl.bibliocommons.com/events/6a97115960ccaf01c0229522' },
      label: 'Hands-on Pick',
    ...
    {
      eventRef: { title: 'Great Glass Pumpkin Patch 2026', aliases: ['Great Glass Pumpkin Patch'], url: 'https://www.paloalto.gov/Departments/Community-Services/Arts-Sciences/Palo-Alto-Art-Center/Special-Events/Pumpkins' },
      label: 'Seasonal Pick',
      whyWePicked: 'More than 10,000 glass pumpkins plus live glass demonstrations turn a free autumn outing into something families can browse, watch, and photograph together.'
    }
  ]
};
