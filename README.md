...
目前来源清单有 22 个机构，其中 3 个图书馆 RSS、1 个官方亲子日历，以及 The Tech 与 Foothill College 两个官方网页日历已直接接入；它们在每个工作日刷新且不消耗 SerpApi 额度。其余 16 个来源的 SerpApi 兜底搜索固定在每周二、周四执行，不在周末运行；约每月 128 次查询，适配 250 次免费额度。
